        ...
        <section className="relative py-20 bg-cloud-dancer overflow-hidden">
            ...
            <div className="max-w-screen-2xl mx-auto px-6 md:px-12 relative z-10">
                ...
                <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-3 gap-4" style={{ gridTemplateRows: 'auto auto' }}>
                    ...
                    <div className="bento-anim relative rounded-2xl bg-electric-mint p-8 flex flex-col justify-between min-h-[270px] ring-1 ring-charcoal/5 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                    ...
                    <Link href="/news-insights/the-end-of-legacy-seo" className="bento-anim group md:row-span-2 rounded-2xl overflow-hidden min-h-[560px] ring-1 ring-charcoal/5 transition-all duration-300 hover:-translate-y-1 block relative">
                        <Image
                    ...
                    <Link href="/news-insights/schema-markup-is-not-optional-the-aeo-technical-checklist" className="bento-anim relative group rounded-2xl overflow-hidden min-h-[270px] ring-1 ring-charcoal/5 transition-all duration-300 hover:-translate-y-1 block">
                        <Image
