...
const manifestoSections = [
    ...
    {
        content: "Security and trust are the final anchors of the agentic transition, managed through protocol-level verification rather than reputation alone. On the settlement side, the x402 protocol guarantees that every payment an agent makes is a cryptographically signed authorization, verified by a facilitator before funds settle on-chain, with an auditable record of the transaction. On the data side, every claim a brand presents to an Answer Engine must be structured, sourced, and consistent across the technical footprint, because citation authority is earned through verifiable data rather than asserted. This is the death of the \"black box\" agency model and the birth of a new era of radical transparency. We provide the structured, verifiable evidence that makes your brand the logical choice for the agentic workforce."
    },
    {
        content: "The final stage of the optimization loop is settlement through the x402 protocol, which closes the gap between the agent's intent and the final payment. Because every x402 payment is a signed authorization settled on-chain, the brand gains an auditable record of every completed agent transaction. That record supports a more sophisticated level of customer modeling, where the brand can adapt its offerings based on what the agentic swarm actually buys rather than on inferred clicks. It is a system built for velocity, moving past the high-friction redirects and manual tracking pixels of the legacy web. By integrating x402 settlement, we ensure that every completed transaction is a verified commercial fact that contributes to the brand’s overall algorithmic weight. This is the foundation of the sovereign digital workforce."
    },
    {
