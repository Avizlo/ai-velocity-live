export const CTABanner = ({
    ...
    return (
        <section className="w-full bg-[#212121] py-24 px-6 md:px-12">
            <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-10">
